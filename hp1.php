				...
				success:function(response){
					...
					var obj=JSON.parse(response);
                        ...
                        $.each(obj,function(index,value){
                           ...
                           hp_content+="<li class='span3'><div class='thumbnail'><img src='"+value.hp_img+"' alt='' style='height: 200px;width: 196.97px;'><div class='caption'  style=''><h5>"+value.hp_name+"</h5><p>"+value.hp_desc+" Click here</p>1<a class='btn' href='hpcart.php'>Add to <i class='icon-shopping-cart'></i></a> <a class='btn btn-primary' href='#'>&euro;"+value.hp_price+"</a></h4></div> </div></li>";
