				...
				success:function(response){
					...
					var obj=JSON.parse(response);
                        ...
                        $.each(obj,function(index,value){
                           ...
                           laptop_content+="<li class='span3'><div class='thumbnail'><img src='"+value.laptop_img+"' alt='' style='height: 200px;width: 196.97px;'></a><div class='caption'  style=''><h5>"+value.laptop_name+"</h5><p>"+value.laptop_desc+" Click here</p><a class='btn' href='laptopcart.php'>Add to <i class='icon-shopping-cart'></i></a> <a class='btn btn-primary' href='#'>&euro;"+value.laptop_price+"</a></h4></div> </div></li>";
