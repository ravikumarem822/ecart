				...
				success:function(response){
					...
					var obj=JSON.parse(response);
                        ...
                        $.each(obj,function(index,value){
                           ...
                           puma_content+="<li class='span3'><div class='thumbnail'><img src='"+value.puma_img+"' alt='' style='height: 200px;width: 196.97px;'><div class='caption'  style=''><h5>"+value.puma_name+"</h5><p>"+value.puma_desc+" Click here</p><a class='btn' href='pumacart.php'>Add to <i class='icon-shopping-cart'></i></a> <a class='btn btn-primary' href='#'>&euro;"+value.puma_price+"</a></h4></div> </div></li>";
