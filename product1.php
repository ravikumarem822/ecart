				...
				success:function(response){
					...
					var obj=JSON.parse(response);
                        ...
                        $.each(obj,function(index,value){
                           ...
                           product_content+="<li class='span3'><div class='thumbnail'><img src='"+value.prd_img+"' alt='' style='height: 200px;width: 196.97px;'><div class='caption'  style=''><h5>"+value.prd_name+"</h5><p>"+value.prd_desc+" Click here</p><a class='btn' href='productcart.php'>Add to <i class='icon-shopping-cart'></i></a> <a class='btn btn-primary' href='#'>&euro;"+value.prd_price+"</a></h4></div> </div></li>";
