...
<div class="tab-content">
	...
	<div class="tab-pane  active" id="blockView">
		<ul class="thumbnails" id="sandiski">
			<!-- <li class="span3">
			  <div class="thumbnail">
				<a href="product_details.html"><img src="sandiskp1.jpg" alt=""/ style="height: 200px;width: 196.97px;"></a>
			...
			<li class="span3">
			  <div class="thumbnail">
				<a href="product_details.html"><img src="sandisk1.jpg" alt=""/></a>
				<div class="caption">
				  <h5>Manicure &amp; Pedicure</h5>
				  <p> 
					I'm a paragraph. Click here 
			...
			$.ajax({
				...
				success:function(response){
					...
					var obj=JSON.parse(response);
                        ...
                        var sandisk_content=""
                        $('#sandiski').find('tr:not(:first)' ).remove();
                        $.each(obj,function(index,value){

                           sandisk_content+="<li class='span3'><div class='thumbnail'><img src='"+value.sandisk_img+"' alt='' style='height: 200px;width: 196.97px;'><div class='caption'  style=''><h5>"+value.sandisk_name+"</h5><p>"+value.sandisk_desc+" Click here</p><a class='btn' href='checkout1.php'>Buy Now</a><a class='btn' href='sandiskcart.php'>Add to <i class='icon-shopping-cart'></i></a> <a class='btn btn-primary' href='#'>&euro;"+value.sandisk_price+"</a></h4></div> </div></li>";

                        });
                        $("#sandiski").append(sandisk_content);
