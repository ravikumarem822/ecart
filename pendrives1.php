				...
				success:function(response){
					...
					var obj=JSON.parse(response);
                        ...
                        $.each(obj,function(index,value){
                           ...
                           pendrive_content+="<li class='span3'><div class='thumbnail'><img src='"+value.pendrive_img+"' alt='' style='height: 200px;width: 196.97px;'><div class='caption'  style=''><h5>"+value.pendrive_name+"</h5><p>"+value.pendrive_desc+" Click here</p><a class='btn' href='pendrivecart.php'>Add to <i class='icon-shopping-cart'></i></a> <a class='btn btn-primary' href='#'>&euro;"+value.pendrive_price+"</a></h4></div> </div></li>";
