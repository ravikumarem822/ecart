				...
				success:function(response){
					...
					var obj=JSON.parse(response);
                        ...
                        $.each(obj,function(index,value){
                           ...
                           sony_content+="<li class='span3'><div class='thumbnail'><img src='"+value.sony_img+"' alt='' style='height: 200px;width: 196.97px;'><div class='caption'  style=''><h5>"+value.sony_name+"</h5><p>"+value.sony_desc+" Click here</p><a class='btn' href='index1.php'>Add to <i class='icon-shopping-cart'></i></a> <a class='btn btn-primary' href='#'>&euro;"+value.sony_price+"</a></h4></div> </div></li>";
