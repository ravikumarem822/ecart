...
<div class="tab-content">
	...
	<div class="tab-pane  active" id="blockView">
		<ul class="thumbnails" id="tvs">
			...
			<li class="span3">
			  <div class="thumbnail">
				<a href="product_details.html"><img src="tv1.jpeg" alt=""/></a>
				<div class="caption">
				  <h5>Manicure &amp; Pedicure</h5>
				  <p> 
					I'm a paragraph. Click here 
			...
			$.ajax({
				...
				success:function(response){
					...
					var obj=JSON.parse(response);
                        ...
                        var tv_content=""
                        $('#tvs').find('tr:not(:first)' ).remove();
                        $.each(obj,function(index,value){

                           tv_content+="<li class='span3'><div class='thumbnail'><img src='"+value.tv_img+"' alt='' style='height: 200px;width: 196.97px;'><div class='caption'  style=''><h5>"+value.tv_name+"</h5><p>"+value.tv_desc+" Click here</p><a class='btn' href='checkout1.php'>Buy Now</a><a class='btn' href='tvcart.php'>Add to <i class='icon-shopping-cart'></i></a> <a class='btn btn-primary' href='#'>&euro;"+value.tv_price+"</a></h4></div> </div></li>";

                        });
                        $("#tvs").append(tv_content);
