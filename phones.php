			...
			$.ajax({
				...
				success:function(response){
					...
					var obj=JSON.parse(response);
                        ...
                        var phone_content=""
                        $('#phones').find('tr:not(:first)' ).remove();
                        $.each(obj,function(index,value){

                           phone_content+="<li class='span3'><div class='thumbnail'><img src='"+value.phone_img+"' alt='' style='height: 200px;width: 196.97px;'></a><div class='caption'  style=''><h5>"+value.phone_name+"</h5><p>"+value.phone_desc+" Click here</p><a class='btn' href='checkout1.php'>Buy Now</a><a class='btn' href='phonecart.php'>Add to <i class='icon-shopping-cart'></i></a> <a class='btn btn-primary' href='#'>&euro;"+value.phone_price+"</a></h4></div> </div></li>";

                        });
                        $("#phones").append(phone_content);
