...
<div class="tab-content">
	...
	<div class="tab-pane  active" id="blockView">
		<ul class="thumbnails" id="products">
			<!-- <li class="span3">
			  <div class="thumbnail">
				<a href=""><img src="hpp1.jpg" alt=""/ style="height: 200px;width: 196.97px;"></a>
			...
			<!-- <li class="span3">
			  <div class="thumbnail">
				<a href=""><img src="sam1.jpeg" alt=""/></a>
				<div class="caption">
				  <h5>Manicure &amp; Pedicure</h5>
				  <p> 
					I'm a paragraph. Click here 
			...
			<li class="span3">
			  <div class="thumbnail">
				<a href=""><img src="phone1.jpeg" alt=""/></a>
				<div class="caption">
				  <h5>Manicure &amp; Pedicure</h5>
				  <p> 
					I'm a paragraph. Click here 
			...
			<li class="span3">
			  <div class="thumbnail">
				<a href=""><img src="dell1.jpg" alt=""/></a>
				<div class="caption">
				  <h5>Manicure &amp; Pedicure</h5>
				  <p> 
					I'm a paragraph. Click here 
				...
				success:function(response){
					...
					var obj=JSON.parse(response);
                        ...
                        $.each(obj,function(index,value){
                           ...
                           product_content+="<li class='span3'><div class='thumbnail'><img src='"+value.prd_img+"' alt='' style='height: 200px;width: 196.97px;'><div class='caption'  style=''><h5>"+value.prd_name+"</h5><p>"+value.prd_desc+" Click here</p><a class='btn' href='checkout1.php'>Buy Now</a><a class='btn' href='productcart.php'>Add to <i class='icon-shopping-cart'></i></a> <a class='btn btn-primary' href='#'>&euro;"+value.prd_price+"</a></h4></div> </div></li>";
				...
				success: function(response){
					...
					var obj=JSON.parse(response);
                        ...
                        $.each(obj,function(index,value){
                        	...
                        	product_content+="<li class='span3'><div class='thumbnail'><img src='"+value.prd_img+"' alt='' style='height: 200px;width: 196.97px;'><div class='caption'  style=''><h5>"+value.prd_name+"</h5><p>"+value.prd_desc+" Click here</p><a class='btn' href='checkout1.php'>Buy Now</a><a class='btn' href='productcart.php'>Add to <i class='icon-shopping-cart'></i></a> <button class='btn btn-primary'>&euro;"+value.prd_price+"</button></h4></div> </div></li>";
