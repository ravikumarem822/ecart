...
<div class="tab-content">
	...
	<div class="tab-pane  active" id="blockView">
		<ul class="thumbnails" id="pendrives">
			<!-- <li class="span3">
			  <div class="thumbnail">
			...
			<li class="span3">
			  <div class="thumbnail">
				<a href="product_details.html"><img src="pendrive4.jpg" alt=""/></a>
				<div class="caption">
				  <h5>Manicure &amp; Pedicure</h5>
				  <p> 
					I'm a paragraph. Click here 
			...
			<li class="span3">
			  <div class="thumbnail">
				<a href="product_details.html"><img src="pendrive1.jpeg" alt=""/></a>
				<div class="caption">
				  <h5>Manicure &amp; Pedicure</h5>
				  <p> 
					I'm a paragraph. Click here 
			...
			$.ajax({
				...
				success:function(response){
					...
					var obj=JSON.parse(response);
                        ...
                        var pendrive_content=""
                        $('#pendrives').find('tr:not(:first)' ).remove();
                        $.each(obj,function(index,value){

                           pendrive_content+="<li class='span3'><div class='thumbnail'><img src='"+value.pendrive_img+"' alt='' style='height: 200px;width: 196.97px;'><div class='caption'  style=''><h5>"+value.pendrive_name+"</h5><p>"+value.pendrive_desc+" Click here</p><a class='btn' href='checkout1.php'>Buy Now</a><a class='btn' href='pendrivecart.php'>Add to <i class='icon-shopping-cart'></i></a> <a class='btn btn-primary' href='#'>&euro;"+value.pendrive_price+"</a></h4></div> </div></li>";

                        });
                        $("#pendrives").append(pendrive_content);
