				...
				success:function(response){
					...
					var obj=JSON.parse(response);
                        ...
                        $.each(obj,function(index,value){
                        	alert(value.shoe_id)
                            table_content+="<tr>";
                            table_content+="<td>"+value.pendrive_id+"</td>";
                           
                            table_content+="<td>"+value.pendrive_brand+"</td>";
                            table_content+="<td>"+value.pendrive_desc+"</td>";
                            table_content+="<td>"+value.pendrive_price+"</td>";
                            table_content+="<td>"+value.pendrive_name+"</td>";
                            table_content+="<td>"+value.pendrive_img+"</td>";
   table_content+="<td><a class='btn btn-primary' href='pendriveedit.php?pendrive_id="+value.pendrive_id+"'>Edit</a><button class='btn btn-danger' onclick='delet("+value.pendrive_id+")'>Delete</button></td>";
                            table_content+="</tr>";
                        });
