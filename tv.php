				...
				success:function(response){
					...
					var obj=JSON.parse(response);
                        ...
                        $.each(obj,function(index,value){
                        	alert(value.shoe_id)
                            table_content+="<tr>";
                            table_content+="<td>"+value.tv_id+"</td>";
                           
                            table_content+="<td>"+value.tv_brand+"</td>";
                            table_content+="<td>"+value.tv_desc+"</td>";
                            table_content+="<td>"+value.tv_price+"</td>";
                            table_content+="<td>"+value.tv_name+"</td>";
                            table_content+="<td>"+value.tv_img+"</td>";
   table_content+="<td><a class='btn btn-primary' href='tvedit.php?tv_id="+value.tv_id+"'>Edit</a><button class='btn btn-danger' onclick='delet("+value.tv_id+")'>Delete</button></td>";
                            table_content+="</tr>";
                        });
