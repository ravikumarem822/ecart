				...
				success:function(response){
					...
					var obj=JSON.parse(response);
                        ...
                        $.each(obj,function(index,value){
                        	alert(value.shoe_id)
                            table_content+="<tr>";
                            table_content+="<td>"+value.shoe_id+"</td>";
                           
                            table_content+="<td>"+value.shoe_brand+"</td>";
                            table_content+="<td>"+value.shoe_desc+"</td>";
                            table_content+="<td>"+value.shoe_price+"</td>";
                            table_content+="<td>"+value.shoe_name+"</td>";
                            table_content+="<td>"+value.shoe_img+"</td>";
   table_content+="<td><a class='btn btn-primary' href='shoeedit.php?shoe_id="+value.shoe_id+"'>Edit</a><button class='btn btn-danger' onclick='delet("+value.shoe_id+")'>Delete</button></td>";
                            table_content+="</tr>";
                        });
